...
dir.create(file.path(pathToFigures), showWarnings = FALSE)
...
# due to limitation of file size on GitHub, had to break up data by slide
...
slides = unique(dat.marker_SEG[,"slide"])  
